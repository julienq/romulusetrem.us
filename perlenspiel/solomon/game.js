  ...
  var SZ = 16,     // Size of the game world
    ...
    WORLDS = [
      ...
      [
        ...
        [ "****************",  // 2-10 TODO moving enemies ~, not falling
          "****************",
          "*****  @  ******",
          "**     *    ****",
          "**      <>    **",
    ...
    WORLD = WORLDS.length - 1,         // Current world number
    LEVEL = WORLDS[WORLD].length - 1;  // Current level number
